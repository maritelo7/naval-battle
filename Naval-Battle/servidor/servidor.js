  ...
  io.on("connection", function(socket){
      ...
      //io.sockets.connected[encontrarIDAdversario(nombreUsuario)].emit("recibirAbandono", function () {});
  	//});
    socket.on("adiosAdversario", function (nombreUsuario, nombreRetado) {
      mostrarDisponible(nombreUsuario);
      mostrarDisponible(nombreRetado);
    });
    socket.on("notificarAbandonoAdversario", function (nombreRetado) {
      io.sockets.connected[encontrarID(nombreRetado)].emit("recibirAbandono", function () {});
    });
